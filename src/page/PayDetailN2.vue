    ...
    <div class="cont">
        ...
        <div class="cont-box bg_ff">
            <div class="details">
                ...
                <div class="mt-36 df df-r ai-c just-c-bet">
        ...
        <van-overlay :show="showHbDom" class="df df-c ai-c just-c-ct" @click="showHbDom=false">
            <div id="bill" ref="bill" class="bill shadow" @click.stop>
                ...
                <div v-if="data.sales_posterss_coords.showName!=='false'" ref="name" class="name fs_24 c_99" :style="{left:testIsTrue('namex'), top:testIsTrue('namey')}">{{info.nickname}}</div>
                <div v-if="data.sales_posterss_coords.showHead!=='false'" class="user" :style="{left:testIsTrue('headx'), top:testIsTrue('heady')}">
                ...
                <div class="ewmbox" :style="{left:testIsTrue('erweix'), top:testIsTrue('erweiy')}">
                    ...
                    <vue-qr :text="share_url" class="ewm"></vue-qr>
                </div>
            </div>
        </van-overlay>
...
export default {
    ...
    methods: {
        ...
        createImg(){
            ...
            let scale = 2;
            let x = (document.documentElement.clientWeight - width)/2;
            let y = (document.documentElement.clientheight - height)/2;
